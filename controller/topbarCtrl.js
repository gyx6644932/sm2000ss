;(function(app){
    app.controller('topbarCtrl',['$scope','$rootScope','$http','$state',"$timeout", "$translate", "publicService",function($scope,$rootScope,$http,$state,$timeout,$translate,publicService){
